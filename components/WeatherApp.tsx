...
import { MapPin, Clock, Eye, Wind, Droplets, Sun, Cloud, CloudRain, CloudSnow } from 'lucide-react';
...
export default function WeatherApp() {
  ...
  const { data: currentWeatherData, isPending: isLoadingCurrentWeatherData } = useQuery({
    ...
    <div className="min-h-screen bg-gray-50 max-w-sm mx-auto relative">
      ...
      <div className="px-4 py-2 bg-white mx-4 rounded-lg shadow-sm mb-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{isLoadingCurrentWeatherData ? '...' : currentWeatherData?.outTemp}°</div>
            <div className="text-sm text-gray-500">Temperature</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-500">{isLoadingCurrentWeatherData ? '...' : currentWeatherData?.outHumi}%</div>
      ...
      <div className="px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          {!isLoadingLastWeekData && lastWeekData && lastWeekData.map((day, index) => (
            <div key={index}>
              <button
                type="button"
